...
class RGBEyes(object):
    ...
    def setArray(self, values, I2CAddress = I2C_ADDRESS):
        ...
        for index, (r, g, b) in enumerate(values):
            ...
            if (r > RGBEyes.BRIGHTNESS_MAX):
                r = RGBEyes.BRIGHTNESS_MAX
    
            if (g > RGBEyes.BRIGHTNESS_MAX):
                g = RGBEyes.BRIGHTNESS_MAX
    
            if (b > RGBEyes.BRIGHTNESS_MAX):
                b = RGBEyes.BRIGHTNESS_MAX
