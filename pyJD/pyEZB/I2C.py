...
class I2C(object):
    ...
    def write(self, deviceAddress, data):
        ...
        writeAddress8Bit = deviceAddress if deviceAddress >= 128 else deviceAddress << 1
    ...
    def read(self, deviceAddress, expectedBytesReturn):
        ...
        readAddress8Bit = (deviceAddress if deviceAddress >= 128 else deviceAddress << 1) | 1

        return self._ezb.sendCommand( expectedBytesReturn,
                                      self._ezb.CmdI2CRead,
                                      bytearray([readAddress8Bit, expectedBytesReturn]) )
